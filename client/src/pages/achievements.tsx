...
import { Plus, Star, Trophy, Target, MessageSquare, Mic } from "lucide-react";
  ...
  const createAchievementMutation = useMutation({
    mutationFn: async (data: any) => {
      ...
      const requestData = {
        ...
        conditionType: data.conditionType || 'message_count',
        conditionValue: data.conditionValue || 100
      };
        ...
        <Dialog open={isCreateOpen} onOpenChange={setIsCreateOpen}>
          ...
          <DialogContent className="max-w-xl">
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <Label htmlFor="conditionType">달성 조건</Label>
                  <Select
                ...
                <div>
                  ...
                  <div className="flex items-center space-x-4 mt-2">
                    <span className="text-green-500 text-sm">
                      보상: {achievement.rewards?.points || achievement.pointReward || 0} 포인트
                    </span>
                  </div>
                </div>
              </div>
